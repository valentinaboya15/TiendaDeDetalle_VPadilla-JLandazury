...
<h1> Actualizar datos del Producto </h1>
    <form action="{{ url('Productos/actualizadoPro',$producto->id) }}" method="POST">
        @csrf
...
<input type="file" name="foto" id="foto"><br><br>
        ...
        <button type="submit" class="btn btn-success">Actualizar </button><br><br>

    </form>
    
    <td> <a href="{{ url('Productos/listado_producto') }}" class="btn btn-success">Cancelar</a></td>
